...
return new class extends Migration
{
    ...
    {
        Schema::create('tesis_nilaisemhas_pembimbing1', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tesis_pembimbing_id')->constrained('tesis_pembimbing_elektro')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('tesis_nilaisemhas_pembimbing1');
    }
};
